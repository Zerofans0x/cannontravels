...
//   const [gatewayChoice, setGatewayChoice] = useState<"paystack" | "nowpayments">("paystack");
...
//       } else {
//         // 2. Initialize payment gateway invoice for Self Checkout
//         const paymentRes = await api.post("/payments/initialize", {
//           bookingId: bookingData._id,
//           gateway: gatewayChoice
//         });

//         // 3. Redirect user to Paystack / NOWPayments checkout page
...
//                   <span className="text-xs text-slate-500 font-medium">Pay directly via card or crypto</span>
//                 </button>
...
//                 <label className="block text-xs font-bold text-slate-700 uppercase">Select Payment Gateway</label>
//                 <div className="grid grid-cols-2 gap-3">
//                   <button
//                     type="button"
//                     onClick={() => setGatewayChoice("paystack")}
//                     className={`p-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
//                       gatewayChoice === "paystack" ? "border-[#DC2626] bg-red-50 text-[#DC2626]" : "border-slate-200 bg-slate-50 text-slate-600"
//                     }`}
//                   >
//                     Paystack (Card / Bank)
//                   </button>
//                   <button
//                     type="button"
//                     onClick={() => setGatewayChoice("nowpayments")}
//                     className={`p-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
//                       gatewayChoice === "nowpayments" ? "border-[#DC2626] bg-red-50 text-[#DC2626]" : "border-slate-200 bg-slate-50 text-slate-600"
//                     }`}
//                   >
//                     NOWPayments (Crypto)
//                   </button>
...
//               ) : (
//                 <>
//                   <span>{paymentMode === "self" ? `Proceed to ${gatewayChoice === 'paystack' ? 'Paystack' : 'Crypto'} Checkout` : "Generate Sponsor Link"}</span>
