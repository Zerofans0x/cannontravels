        ...
        <div className="space-y-6">
          <div className="bg-slate-900 rounded-3xl p-6 text-white relative overflow-hidden shadow-md">
            ...
            <p className="text-slate-400 text-sm mb-5">
              Generated a payment link for a sponsor? Track its payment status here.
            </p>
            <button className="w-full py-2.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl text-sm transition-colors border border-white/10">
              View Links
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm">
            ...
            <p className="text-slate-500 text-sm mb-4">
              Enter a passenger tracking ID to monitor real-time location.
            </p>
            <div className="flex items-center gap-2">
              ...
              />
              <button className="w-10 h-10 bg-[#DC2626] hover:bg-[#B91C1C] text-white rounded-xl flex items-center justify-center transition-colors">
